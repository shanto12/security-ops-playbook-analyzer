...
export const toolEndpoints = [
  ...
  { name: 'Shodan', endpoint: '/api/shodan/host', agent: 'Enrichment Agent' },
  { name: 'Firewall', endpoint: '/api/firewall/block', agent: 'Containment Agent' },
  { name: 'EDR', endpoint: '/api/edr/endpoint', agent: 'Endpoint Investigation Agent' },
  { name: 'Slack', endpoint: '/api/slack/notify', agent: 'Notification Agent' },
  { name: 'WHOIS', endpoint: '/api/whois/lookup', agent: 'Enrichment Agent' },
