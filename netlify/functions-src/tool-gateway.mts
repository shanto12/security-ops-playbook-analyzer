    ...
    messages: [
      {
        ...
        content:
          ...
          'Use 6 compact top-level keys from the schema hint. Arrays must contain at most 2 short items. Complete the JSON object within 450 tokens. Produce a realistic but synthetic response. ' +
...
export const config: Config = {
  path: Object.keys(toolSpecs) as `/${string}`[],
}
